...
对于一些源代码的更改需求，我们可以更改 AST,然后将 AST 重新生成源代码，实现代码的灵活更改，这也是 AST 可以用来做 IDE插件(如代码语法检查，代码风格检查，代码的格式化，代码高亮，代码错误), 转换代码的工具 代码的混淆压缩重要原因。
...
```
注： 
下文讲的是 JavaScriptCore 引擎， V8 中是不会转化为字节码的，而是直接转换为本地码。  
