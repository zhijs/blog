随着 JavasScript 语言逐渐发展，JavaScript 从以前的简单网页交互到现在的大型网站的复杂交互，再到移动端甚至 PC 客户端的语言支持。JavaScript 工程代码变得越来越庞大，其代码的管理变得越来越困难，于是乎 JavaScript 模块化方案在社区中应声而起，其中的一些优秀的模块化方案，逐渐成为 JavaScript 的语言规范，下面我们就 JavaScript 模块化这个话题展开讨论，本文的主要有以下内容。
